class Date {
     ...
     *  be one or two digits, day must be one or tow digits, and year must be 
     ...
     *  @return true if and only lif this Date is before d. 
     */ 
     ...
     *  If this Date occurs vefore d, the result is negative. 
