...
/*
    ...
    //String command = bankApp.readLine("--> ");
      ...
      System.out.println("IO problem happens when read line.");
    }
  ...
  *  @exception IOException if there are problems reading user input.
  */
  private void doDeposit() throws BadTransactionException, IOException {
    // Get account number.
  ...
  private void doWithdraw() throws IOException, BadAccountException {
    ...
    // Make sure the amount to withdraw is positive.
