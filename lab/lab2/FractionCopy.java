...
class Fraction {
     ...
     *  @param d is the denomunator. Must be positive. 
     */ 
     ...
     *  Fractions should printed in reduced form (part of your assignment is 
     *  to make this true). 
     ...
     *  @return the result of adding f2 to this Fration. 
     */ 
    ...
    public static void main(String[] argv) {
        ...
        /* Test all four constructors and toString */
        ...
        System.out.println("The fraction f1 is " + f1.toString());
        System.out.println("The fraction f2 is " + f2.toString());
        System.out.println("The fraction f3 is " + f3 + ", which should equal f2");

        /* Test the add method. */ 
        System.out.println("\nTesting add:");

        Fraction sumOfTwo = f1.add(f2);       // sum of f2. 
        Fraction sumOfThree = f0.add(f2.add(f2));        // Sum of f0, f1, and f2.
